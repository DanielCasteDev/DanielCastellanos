...
const translations = {
  en: {
    ...
    'projects.project2': 'Attack Detection System with Hash Encryption',
    'projects.project2Description': 'This project implements a security system that detects potential attacks on a network. It uses hash encryption algorithms to secure data, ensuring the integrity and safety of information within the system.',
  ...
  es: {
    ...
    'projects.project2': 'Sistema de Detección de Ataques con Encriptación Hash',
    'projects.project2Description': 'Este proyecto implementa un sistema de seguridad que detecta posibles ataques en una red. Utiliza algoritmos de encriptación hash para asegurar los datos, garantizando la integridad y seguridad de la información dentro del sistema.',
